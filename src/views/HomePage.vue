  ...
  <div class="container">
    <div class="content mb-4">
      <div class="section">
        ...
        <h2 class="my-5" style="text-align: center">razvoj in promocija odprtokodnih geoprostorskih tehnologij ter odprtih podatkovnih standardov v
          Sloveniji</h2>
      </div>
      <div class="section">
        <h3>Dogodki in novice</h3>
      ...
      <div class="section">
        <div class="contact-container">
          ...
          <div class="icon-container">
            ...
            <a href="https://discord.gg/XQGqrz8CgA" target="_blank">
              <img src="../assets/discord.svg" alt="Discord" class="icon"/>
            </a>
            <a href="https://www.linkedin.com/company/osgeo-slovenija/about" target="_blank">

    ...
    <div class="content">
      ...
      Kje tebe karta žuli so odprti kartografski dogodki, namenjeni vsem, ki želijo ustvarjati, izboljševati ali raziskovati svet zemljevidov. Srečanja so priložnost za sodelovanje, izmenjavo znanja in reševanje konkretnih izzivov pri:
       ...
       <ul class="m-5">
        ...
        <li>izdelavi kart za različne namene (prostorski podatki, načrtovanje, vizualizacija),</li>
        <li>povezovanju kartografskih virov,</li>
        <li>dopolnjevanju OpenStreetMap,</li>
        <li>učenju novih kartografskih orodij in tehnik.</li>
      </ul>
